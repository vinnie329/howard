...
const sources: Array<{
  ...
  },
  {
    ...
    youtube_search_queries: ['Brad Gerstner Altimeter', 'Brad Gerstner interview'],
    substack_url: null,
  },
  {
    name: 'Josh Wolfe',
    ...
    youtube_search_queries: ['Josh Wolfe Lux Capital', 'Josh Wolfe interview'],
    substack_url: null,
  },
  {
    name: 'Jeff Currie',
    ...
    youtube_search_queries: ['Jeff Currie Carlyle', 'Jeff Currie Goldman Sachs commodities'],
    substack_url: null,
  },
  {
    name: 'Goldman Sachs',
    slug: 'goldman-sachs',
    bio: 'Goldman Sachs official channel. Research, strategy, and market outlook from GS analysts and leadership.',
    avatar_url: '/avatars/goldman-sachs.jpg',
    domains: ['Macro / Liquidity', 'AI / Semiconductors'],
    scores: {
      intelligence: 4,
      intuition_eq: 4,
      sincerity: 3,
    ...
    youtube_search_queries: ['Goldman Sachs'],
    substack_url: null,
  },
  {
    name: 'Thomas Laffont',
    slug: 'thomas-laffont',
    bio: 'Co-founder and co-managing partner of Coatue Management. Technology-focused investor spanning public and private markets with deep expertise in software, internet, and AI infrastructure.',
    avatar_url: '/avatars/thomas-laffont.jpg',
    domains: ['AI / Semiconductors', 'Venture / Startups'],
    scores: {
      intelligence: 4,
      intuition_eq: 4,
      sincerity: 4,
    ...
    youtube_search_queries: ['Thomas Laffont Coatue', 'Thomas Laffont interview'],
    substack_url: null,
  },
  {
    name: 'Dan Sundheim',
