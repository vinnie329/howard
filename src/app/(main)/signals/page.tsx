...
export default function SignalsPage() {
  ...
  return (
    <>
      ...
      <div className="page-two-col" style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
        {/* Main content */}
        <div className="page-two-col-main" style={{ flex: 1, padding: 'var(--space-6)', overflowY: 'auto', display: 'flex', justifyContent: 'center' }}>
